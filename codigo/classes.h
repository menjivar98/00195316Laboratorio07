...
enum parameters {TAU_CONST, KAPPA_CONST, LAMBDA_CONST, IPSILON_CONST, DELTA_CONST, PSI_CONST, ETA_CONST};
...
class mesh{
    ...
    public:
        void setParameters(float tau,float kappa, float lambda, float ipsilon, float delta, float psi, float eta){
